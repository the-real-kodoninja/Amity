...
function App() {
    ...
    (0, _react.useEffect)(()=>{
        const backendUrl = 'https://fantastic-journey-jvxpjqpr6qf5wwq-8080.app.github.dev';
        (0, _axiosDefault.default).get(`${backendUrl}/users/emoorephp`).then((res)=>setUser(res.data)).catch((err)=>console.error(err));
        (0, _axiosDefault.default).get(`${backendUrl}/feed`).then((res)=>setPosts(res.data)).catch((err)=>console.error(err));
        (0, _axiosDefault.default).get(`${backendUrl}/users/emoorephp/photos`).then((res)=>setPhotos(res.data)).catch((err)=>console.error(err));
    }, []);
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        children: [
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("ul", {
                children: posts.map((post)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("li", {
                        children: [
                            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("p", {
                                children: [
                                    post.content,
                            ...
                            post.image_url && /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("img", {
                                src: post.image_url,
                                alt: "Post"
                            }, void 0, false, {
                                fileName: "src/App.js",
            ...
            /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("ul", {
                children: photos.map((photo)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("li", {
                        children: [
...
_s(App, "YfmbLAQxe1g+SbLOh4fZ5m/GMek=");
_c = App;
exports.default = App;
var _c;
$RefreshReg$(_c, "App");
...
},{"react/jsx-dev-runtime":"react/jsx-dev-runtime","react":"react","axios":"axios","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}]},["02ujV","j6hSo"], "j6hSo", "parcelRequire10c2")
